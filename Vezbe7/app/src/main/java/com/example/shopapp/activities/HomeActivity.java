    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        * */
        ...
        mAppBarConfiguration = new AppBarConfiguration
                .Builder(R.id.nav_products, R.id.nav_new, R.id.nav_profile, R.id.nav_logout,
                R.id.nav_settings, R.id.nav_language, R.id.nav_product_detail, R.id.nav_product_edit)
